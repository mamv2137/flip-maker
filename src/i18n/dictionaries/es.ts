const es = {
  ...
  landing: {
    ...
    footer: {
      description: 'Transforma tu contenido en flipbooks interactivos premium.',
      product: 'Producto',
      resources: 'Recursos',
      legal: 'Legal',
      ...
      signUp: 'Registrarse',
      copyright: '© {year} Flipbooks. Todos los derechos reservados.',
    },
    logoCloud: {
      ...
      plans: {
        free: {
          ...
          features: [
            ...
            'Watermark "Powered by Flipbooks"',
          ],
        },
        creator: {
          name: 'Creator',
