const es = {
  ...
  landing: {
    ...
    demo: {
      ...
      tryYours: 'Probar con el mío',
      backToDemo: '← Volver al demo',
      tryTitle: 'Pega un link público de Google Drive',
      tryDescription: 'El archivo debe estar compartido como "Cualquiera con el link".',
      tryPrivacy: 'Renderizamos el PDF al vuelo. No subimos, ni guardamos, ni indexamos nada.',
      placeholder: 'https://drive.google.com/file/d/.../view',
      loadButton: 'Cargar mi PDF',
      loading: 'Cargando tu PDF...',
      errorInvalidUrl: 'No es un link válido de Google Drive. Pega el link de "Compartir".',
      errorNotPublic: 'No pudimos acceder al archivo. Asegúrate de que esté compartido como "Cualquiera con el link" en Google Drive.',
      errorTooLarge: 'El archivo es muy grande para el demo (máx. 50 MB).',
      errorGeneric: 'No pudimos cargar el PDF. Intenta de nuevo.',
    },
    cta: {
