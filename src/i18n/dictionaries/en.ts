const en = {
  ...
  landing: {
    ...
    demo: {
      ...
      tryYours: 'Try with mine',
      backToDemo: '← Back to demo',
      tryTitle: 'Paste a public Google Drive link',
      tryDescription: 'The file must be shared as "Anyone with the link".',
      tryPrivacy: 'We render the PDF on the fly. No uploads, no storage, no indexing.',
      placeholder: 'https://drive.google.com/file/d/.../view',
      loadButton: 'Load my PDF',
      loading: 'Loading your PDF...',
      errorInvalidUrl: 'Not a valid Google Drive link. Paste the "Share" link.',
      errorNotPublic: 'We couldn\'t access the file. Make sure it\'s shared as "Anyone with the link" on Google Drive.',
      errorTooLarge: 'The file is too large for the demo (50 MB max).',
      errorGeneric: 'We couldn\'t load the PDF. Please try again.',
    },
    cta: {
    ...
    pricing: {
      ...
      overage: 'Overage: $0.005 per additional view',
    },
  },
  common: {
    loading: 'Loading...',
